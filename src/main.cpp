...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x0000059b913ff73ca11e06a5fd35cf825d4501d1649742c25366c3094b0a5b20");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // QPSCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "QPSCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000059b913ff73ca11e06a5fd35cf825d4501d1649742c25366c3094b0a5b20");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("QPSCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("QPSCoinCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("QPSCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("QPSCoin-miner");
    ...
    try { loop {
        ...
        printf("Running QPSCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("QPSCoinMiner terminated\n");
        throw;
    }
}
